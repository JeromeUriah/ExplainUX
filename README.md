...
ExplainUX was designed to explore how automated agents can assist with usability evaluation and heuristic application. The system modularizes evaluation logic into reusable components, enabling structured and interpretable UX analysis.
The repository includes:
* app.py — main application entry point
* agents.py — modular agent logic for UX evaluation workflows
* heuristics.py — structured heuristic definitions and scoring logic
* ExplainUX.pdf — project documentation
